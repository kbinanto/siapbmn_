...
<div class="main-panel" id="main-panel">
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">IMPORT DATA / REKON SP2D BMN AKUN 53</a>
            </div>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal" action="{{url('/Import_Sp2d53/Import_Excel_Sp2d53')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            ...
                            <code>pastikan file yang akan anda import adalah file dari e-rekon menu rekon sp2d bmn akun 53</code>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger"
                            ...
                            href="{{url('/Import_Sp2d53/Pengosongan_Sp2d53')}}">Pengosongan Data</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><label>Akun : {{$s->akun}}</label>
                                        <br>
                                        <label>no. dokumen : {{$s->no_dokumen}}</label>
                                        <br>
                                        <label>tgl. dokumen : {{$s->tgl_dokumen}}</label>
                                    </td>
