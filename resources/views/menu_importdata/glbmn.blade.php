...
<div class="main-panel" id="main-panel">
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">IMPORT DATA / REKON GLBMN</a>
            </div>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal" action="{{url('/Import_Glbmn/Import_Excel_Glbmn')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            ...
                            <code>pastikan file yang akan anda import adalah file dari e-rekon menu rekon glbmn</code>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Rekon GlBmn</h4>
                        ...
                        <a class="btn btn-danger"
                            ...
                            href="{{url('/Import_Glbmn/Pengosongan_Glbmn')}}">Pengosongan Data</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><label>{{$s->rph_selisih}}</label></td>
