    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">IMPORT DATA / REKONSILIASI INTERNAL</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Import_RekonsiliasiInternal/Import_Excel_RekonsiliasiInternal')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            ...
                            <code>pastikan file yang akan anda import adalah file dari e-rekon menu rekonsiliasi
                                internal</code>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger"
                            ...
                            href="{{url('/Import_RekonsiliasiInternal/Pengosongan_RekonsiliasiInternal')}}">Pengosongan
                            Data</a>
                    </div>
                    <div class="card-body">
