    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">IMPORT DATA / SALDO TIDAK NORMAL</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Import_Saldo_tidak_normal/Import_Excel_Saldo_tidak_normal')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            ...
                            <code>pastikan file yang akan anda import adalah file dari e-rekon menu saldo tidak normal</code>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger"
                            ...
                            href="{{url('/Import_Saldo_tidak_normal/Pengosongan_Saldo_tidak_normal')}}">Pengosongan
                            Data</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 12%"> <label>Debit</label></th>
                                    <th style="width: 12%"> <label>Kredit</label></th>
                                    <th style="width: 12%"> <label>Saldo Normal</label></th>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th style="width: 25%"> <label>Data Satker</label></th>
                                    <th style="width: 22%"> <label>Data Akun</label></th>
                                    <th style="width: 12%"> <label>Debet</label></th>
                                    <th style="width: 12%"> <label>Kredit</label></th>
                                    <th style="width: 12%"> <label>Saldo Normal</label></th>
                                    <th style="width: 12%"> <label>Keterangan</label></th>
                                    <th style="width: 12%"> <label>Tgl Imp</label></th>
