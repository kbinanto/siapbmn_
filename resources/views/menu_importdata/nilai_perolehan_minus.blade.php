    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">IMPORT DATA / NILAI PEROLEHAN MINUS</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Import_Nilai_perolehan_minus/Import_Excel_Nilai_perolehan_minus')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            ...
                            <code>pastikan file yang akan anda import adalah file dari e-rekon menu nilai perolehan
                                minus</code>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger"
                            ...
                            href="{{url('/Import_Nilai_perolehan_minus/Pengosongan_Nilai_perolehan_minus')}}">Pengosongan
                            Data</a>
