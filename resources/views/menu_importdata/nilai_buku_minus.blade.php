    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">IMPORT DATA / NILAI BUKU MINUS</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Import_Nilai_buku_minus/Import_Excel_Nilai_buku_minus')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            ...
                            <code>pastikan file yang akan anda import adalah file dari e-rekon menu nilai buku
                                minus</code>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger"
                            ...
                            href="{{url('/Import_Nilai_buku_minus/Pengosongan_Nilai_buku_minus')}}">Pengosongan Data</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 22%"> <label>Data Satker</label></th>
                                    <th style="width: 12%"> <label>Data Barang</label></th>
