    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / REKLASIFIKASI ASET</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Reklasifikasi Aset</h4>
                        <a href="{{url('/Import_Reklasifikasi_aset/Export_Reklasifikasi_aset')}}"
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 25%"> <label>Kode Satker</label></th>
                                    <th style="width: 22%"> <label>Nama Satker</label></th>
                                    <th style="width: 12%"> <label>Reklas Keluar</label></th>
                                    <th style="width: 12%"> <label>Reklas Masuk</label></th>
                            ...
                            <tbody>
                                @php $i=1 @endphp
                                @foreach($Reklasifikasi_aset as $s)
                                <tr>
                                    ...
                                    <td><label>{{$s->reklas_keluar}}</label></td>
                                    <td><label>{{$s->reklas_masuk}}</label></td>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Reklasifikasi_aset/Import_Excel_Reklasifikasi_aset_Pelaksana')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [reklasifikasi_aset_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Reklasifikasi_aset/Pengosongan_Reklasifikasi_aset_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [reklasifikasi_aset_tmp] >> [reklasifikasi_aset] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [reklasifikasi_aset_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Reklasifikasi_aset/Pengosongan_Reklasifikasi_aset_Pelaksana')}}">4.
