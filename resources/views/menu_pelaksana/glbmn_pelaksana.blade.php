    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / REKON GL BMN</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Rekon GL BMN</h4>
                        <a href="{{url('/Import_Glbmn/Export_Glbmn')}}" class="btn btn-success" target="_blank">Export
                            File</a>
                        <code>
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>Rph Intra : {{$s->rph_intra}}</label>
                                        <br>
                                        <label>Rph KDP : {{$s->rph_kdp}}</label>
                                        <br>
                                        <label>Rph Ekstra : {{$s->rph_ekstra}}</label>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Glbmn/Import_Excel_Glbmn_Pelaksana')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning" onclick="return confirm('tabel [glbmn_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Glbmn/Pengosongan_Glbmn_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [glbmn_tmp] >> [glbmn] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default" onclick="return confirm('tabel [glbmn_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Glbmn/Pengosongan_Glbmn_Pelaksana')}}">4.
