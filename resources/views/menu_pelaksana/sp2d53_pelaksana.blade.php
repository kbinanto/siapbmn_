    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / REKON SP2D BMN AKUN 53</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Rekon SP2D BMN Akun 53</h4>
                        <a href="{{url('Import_Sp2d53/Export_Sp2d53')}}" class="btn btn-success" target="_blank">Export
                            File</a>
                        <code>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Sp2d53/Import_Excel_Sp2d53_Pelaksana')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [sp2d53_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Sp2d53/Pengosongan_Sp2d53_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [sp2d53_tmp] >> [sp2d53] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [sp2d53_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Sp2d53/Pengosongan_Sp2d53_Pelaksana')}}">4.
