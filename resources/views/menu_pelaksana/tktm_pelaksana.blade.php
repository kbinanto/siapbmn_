    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / TRANSFER KELUAR MASUK</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Transfer Keluar Masuk</h4>
                        <a href="{{url('/Import_Tktm/Export_Tktm')}}" class="btn btn-success" target="_blank">Export
                            File</a>
                        <code>
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 12%"> <label>Selisih</label></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <label>Akun : {{$s->kode_akun_pengirim}}</label>
                                        <br>
                                        <label>Uraian : {{$s->uraian_akun_pengirim}}</label>
                                        <br>
                                        <label>Transfer keluar : {{$s->transfer_keluar}}</label>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <label>Transfer Masuk : {{$s->transfer_masuk}}</label>
                                    </td>
                                    <td><label>{{$s->selisih}}</label></td>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Tktm/Import_Excel_Tktm_Pelaksana')}}" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning" onclick="return confirm('tabel [tktm_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Tktm/Pengosongan_Tktm_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [tktm_tmp] >> [tktm] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-deafult" onclick="return confirm('tabel [tktm_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Tktm/Pengosongan_Tktm_Pelaksana')}}">4.
