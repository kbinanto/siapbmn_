    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / REKONSILIASI INTERNAL</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Rekonsiliasi Internal</h4>
                        <a href="{{url('/Import_Aset_belum_register/Export_Aset_belum_register')}}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><label>Akun : {{$s->akun}}</label>
                                        <br>
                                        <label>Uraian : {{$s->nama_akun}}</label>
                                    </td>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Aset_belum_register/Import_Excel_Aset_belum_register_Pelaksana')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [aset_belum_register_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Aset_belum_register/Pengosongan_Aset_belum_register_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [aset_belum_register_tmp] >> [aset_belum_register] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [aset_belum_register_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Aset_belum_register/Pengosongan_Aset_belum_register_Pelaksana')}}">
                                4. Pembersihan Data .tmp</a>
                        </div>
