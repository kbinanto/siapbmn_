    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / TANGGAL BUKU MINUS</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Tanggal Buku Minus</h4>
                        <a href="{{url('/Import_Tanggal_buku_minus/Export_Tanggal_buku_minus')}}"
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 12%"> <label>Tgl Buku</label></th>
                                    <th style="width: 12%"> <label>Tgl Perolehan</label></th>
                            ...
                            <tbody>
                                @php $i=1 @endphp
                                @foreach($Tanggal_buku_minus as $s)
                                <tr>
                                    ...
                                    <td><label>{{$s->tgl_buku}}</label></td>
                                    <td><label>{{$s->tgl_perolehan}}</label></td>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Tanggal_buku_minus/Import_Excel_Tanggal_buku_minus_Pelaksana')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [tanggal_buku_minus_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Tanggal_buku_minus/Pengosongan_Tanggal_buku_minus_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [tanggal_buku_minus_tmp] >> [tanggal_buku_minus] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [tanggal_buku_minus_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Tanggal_buku_minus/Pengosongan_Tanggal_buku_minus_Pelaksana')}}">4.
