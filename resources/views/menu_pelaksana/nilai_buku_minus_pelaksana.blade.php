    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / NILAI BUKU MINUS</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Nilai Buku Minus</h4>
                        <a href="{{url('/Import_Nilai_buku_minus/Export_Nilai_buku_minus')}}" class="btn btn-success"
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 12%"> <label>Rph Susut</label></th>
                                    <th style="width: 12%"> <label>Rph Buku</label></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><label>Kode : {{$s->kode_barang}}</label>
                                        <br>
                                        <label>Nama : {{$s->nama_barang}}
                                            <br>
                                            <label>NUP : {{$s->nomor_aset}}
                                            </label>
                                    </td>
                                    <td><label>{{$s->rph_aset}}</label></td>
                                    <td><label>{{$s->rph_susut}}</label></td>
                                    <td><label>{{$s->rph_buku}}</label></td>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Nilai_buku_minus/Import_Excel_Nilai_buku_minus_Pelaksana')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [nilai_buku_minus_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Nilai_buku_minus/Pengosongan_Nilai_buku_minus_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [nilai_buku_minus_tmp] >> [nilai_buku_minus] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [nilai_buku_minus_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Nilai_buku_minus/Pengosongan_Nilai_buku_minus_Pelaksana')}}">4.
