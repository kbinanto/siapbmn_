    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">ANALISA DATA / SALDO TIDAK NORMAL</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Selisih Saldo Tidak Normal</h4>
                        <a href="{{url('/Import_Saldo_tidak_normal/Export_Saldo_tidak_normal')}}"
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 10%"> <label>Debet</label></th>
                                    <th style="width: 10%"> <label>Kredit</label></th>
                                    <th style="width: 5%"> <label>SN</label></th>
                                    <th style="width: 12%"> <label>Keterangan</label></th>
                                    <th style="width: 22%"> <label>Penjelasan</label></th>
                            ...
                            <tbody>
                                @php $i=1 @endphp
                                @foreach($Saldo_tidak_normal as $s)
                                <tr>
                                    ...
                                    <td><label>trn : {{$s->trn}}</label>
                                        <br>
                                        <label>Akun : {{$s->akun}}</label>
                                        <br>
                                        <label>Uraian : {{$s->uraian_akun}}</label>
                                    </td>
                                    <td><label>{{$s->debet}}</label></td>
                                    <td><label>{{$s->kredit}}</label></td>
                                    <td><label>{{$s->saldo_normal}}</label></td>
                                    <td><label>{{$s->keterangan}}</label></td>
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_Saldo_tidak_normal/Import_Excel_Saldo_tidak_normal_Pelaksana')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [saldo_tidak_normal_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Saldo_tidak_normal/Pengosongan_Saldo_tidak_normal_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [saldo_tidak_normal_tmp] >> [saldo_tidak_normal] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [saldo_tidak_normal_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_Saldo_tidak_normal/Pengosongan_Saldo_tidak_normal_Pelaksana')}}">4.
