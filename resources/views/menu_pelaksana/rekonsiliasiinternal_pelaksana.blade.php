        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{url('/Import_RekonsiliasiInternal/Export_RekonsiliasiInternal')}}"
            ...
            <div class="col-md-12">
                <form id="TypeValidation" class="form-horizontal"
                    action="{{url('/Pelaksana_RekonsiliasiInternal/Import_Excel_RekonsiliasiInternal_Pelaksana')}}"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer text-center">
                            <a class="btn btn-warning"
                                onclick="return confirm('tabel [rekonsiliasi_internal_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_RekonsiliasiInternal/Pengosongan_RekonsiliasiInternal_Pelaksana')}}">1.
                                Pengosongan Data .tmp</a>
                            <button type="submit" class="btn btn-primary">2. Import File</button>
                            <a class="btn btn-danger"
                                onclick="return confirm('sinkronisasi data [rekonsiliasi_internal_tmp] >> [rekonsiliasi_internal] ')"
                                href="http://localhost/siapbmn/sync.php" target="_blank">
                                3. Sinkronisasi Data</a>
                            <a class="btn btn-default"
                                onclick="return confirm('tabel [rekonsiliasi_internal_tmp] akan kita kosongkan')"
                                href="{{url('/Pelaksana_RekonsiliasiInternal/Pengosongan_RekonsiliasiInternal_Pelaksana')}}">4.
