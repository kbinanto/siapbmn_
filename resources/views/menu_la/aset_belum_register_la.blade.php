            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Analisa Rekonsiliasi Internal</h4>
                        <a href="{{url('/Import_Aset_belum_register/Export_Aset_belum_register_AnalisaData')}}"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_Aset_belum_register/Analisaok_Aset_belum_register') }}">Analisa
                            Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_Aset_belum_register/Analisanok_Aset_belum_register') }}">Analisa
                            Tidak Ok
                            (Selected)</button>
                    </div>
                    <div class="card-body">
