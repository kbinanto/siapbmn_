    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">VERIFIKASI VALIDASI / REKLASIFIKASI ASET</a>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Analisa Reklasifikasi Aset</h4>
                        <a href="{{url('/Import_Reklasifikasi_aset/Export_Reklasifikasi_aset_AnalisaData')}}"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_Reklasifikasi_aset/Analisaok_Reklasifikasi_aset') }}">Analisa
                            Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_Reklasifikasi_aset/Analisanok_Reklasifikasi_aset') }}">Analisa
                            Tidak Ok
                            (Selected)</button>
                    </div>
                    <div class="card-body">
