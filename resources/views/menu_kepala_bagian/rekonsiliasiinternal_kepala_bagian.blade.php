            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{url('/Import_RekonsiliasiInternal/Export_RekonsiliasiInternal_AnalisaData')}}"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_RekonsiliasiInternal/Analisaok') }}">Analisa Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_RekonsiliasiInternal/Analisanok') }}">Analisa Tidak Ok
                            (Selected)</button>
