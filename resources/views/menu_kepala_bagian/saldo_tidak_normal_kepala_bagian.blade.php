    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">VERIFIKASI VALIDASI / SALDO TIDAK NORMAL</a>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Analisa Saldo Tidak Normal</h4>
                        <a href="{{url('/Import_Saldo_tidak_normal/Export_Saldo_tidak_normal_AnalisaData')}}"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_Saldo_tidak_normal/Analisaok_Saldo_tidak_normal') }}">Analisa
                            Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_Saldo_tidak_normal/Analisanok_Saldo_tidak_normal') }}">Analisa
                            Tidak Ok
                            (Selected)</button>
                    </div>
                    <div class="card-body">
