    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">VERIFIKASI VALIDASI / NILAI PEROLEHAN MINUS</a>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Analisa Nilai Perolehan Minus</h4>
                        <a href="{{url('/Import_Nilai_perolehan_minus/Export_Nilai_perolehan_minus_AnalisaData')}}"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_Nilai_perolehan_minus/Analisaok_Nilai_perolehan_minus') }}">Analisa
                            Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_Nilai_perolehan_minus/Analisanok_Nilai_perolehan_minus') }}">Analisa
                            Tidak Ok
                            (Selected)</button>
                    </div>
                    <div class="card-body">
