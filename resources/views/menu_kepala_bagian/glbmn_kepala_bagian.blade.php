    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">VERIFIKASI VALIDASI / REKON GL BMN</a>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Analisa Rekon GL BMN</h4>
                        <a href="{{url('/Import_Glbmn/Export_Glbmn_AnalisaData')}}" class="btn btn-success"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_Glbmn/Analisaok_Glbmn') }}">Analisa Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_Glbmn/Analisanok_Glbmn') }}">Analisa Tidak
                            Ok
                            (Selected)</button>
                    </div>
                    <div class="card-body">
