    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        ...
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo">VERIFIKASI VALIDASI / TANGGAL BUKU MINUS</a>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Analisa Tanggal Buku Minus</h4>
                        <a href="{{url('/Import_Tanggal_buku_minus/Export_Tanggal_buku_minus_AnalisaData')}}"
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ url('/Kepala_bagian_Tanggal_buku_minus/Analisaok_Tanggal_buku_minus') }}">Analisa
                            Ok
                            (Selected)</button>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all"
                            data-url="{{ url('/Kepala_bagian_Tanggal_buku_minus/Analisanok_Tanggal_buku_minus') }}">Analisa
                            Tidak Ok
                            (Selected)</button>
                    </div>
                    <div class="card-body">
