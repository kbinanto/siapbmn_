...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76"
        href="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/img/apple-icon.png">
    <link rel="icon" type="image/png" href="{{url('/photo/siapbmn.png')}}">
    ...
    <link href="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/css/now-ui-dashboard.min.css?v=1.5.0"
        rel="stylesheet" />
...
<body class="login-page sidebar-mini ">
    ...
    <div class="wrapper wrapper-full-page ">
        ...
        <div class="full-page login-page section-image" filter-color="black"
            data-image="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/img/bg14.jpg">
                            ...
                            <div class="card card-login card-plain">
                                ...
                                <div class="card-header ">
                                    <div class="logo-container">
                                        <img src="{{url('/photo/siapbmn.png')}}" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="card-footer ">
                                    <button type="submit" class="btn btn-primary btn-round btn-lg btn-block mb-3">Get
                                        Started</button>
                                    <div class="pull-left">
                                        <h6><a href="{{ route('register') }}" class="link footer-link">Create
                                                Account</a></h6>
                                    </div>
    ...
    <script src="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/js/plugins/perfect-scrollbar.jquery.min.js">
    </script>
    ...
    <script src="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/js/plugins/jquery.bootstrap-wizard.js">
    </script>

    <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
    <script src="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/js/plugins/bootstrap-selectpicker.js">
    </script>

    <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
    <script src="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/js/plugins/bootstrap-datetimepicker.js">
    </script>

    <!--  DataTables.net Plugin, full documentation here: https://datatables.net/    -->
    <script src="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/js/plugins/jquery.dataTables.min.js">
    </script>
    ...
    <script src="https://demos.creative-tim.com/now-ui-dashboard-pro/assets/js/now-ui-dashboard.min.js?v=1.5.0"
        type="text/javascript"></script><!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
